#ifndef MIRRORZINHOPUZZLE_H
#define MIRRORZINHOPUZZLE_H
...
class MirrorzinhoPuzzle : public Component
{
public:
    class Piece {
    public:
    ...
    MirrorzinhoPuzzle(GameObject& associated, std::vector<Piece> pieces);
